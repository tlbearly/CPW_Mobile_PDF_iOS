...
struct HelpMapViewController_Representable: UIViewControllerRepresentable {
...
@available(iOS 13.0.0, *)
struct HelpMapViewController_Previews: PreviewProvider {
    static var previews: some View {
        HelpMapViewController_Representable().colorScheme(.dark) // .light or .dark
    }
}
#endif
